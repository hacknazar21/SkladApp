...
export default function Require({ navigation, route }) {
    ...
    const getClientsFromApiAsync = async () => {
        try {
            const response = await fetch(
                'https://sklad.onedevelop.kz/mobileReq.php?type=getAll'
            );
            ...
            if (product["ID_Клиента"] == route.params.ID.ID) {
                newProducts.push(
                    <View style={styles.productBox} key={product["ID"]}>
                        <View style={styles.productBoxTitle} onTouchEnd={() => { loadScreen('Add', product) }}>
                        ...
                        <View style={styles.productBoxBody}>
                            <View style={styles.productBodyItem}>
                                ...
                                <Text style={styles.productBodyItemValue}>-</Text>
                            </View>
                            <View style={styles.separator}></View>
                            <View style={styles.productBodyItem}>
                                <Text style={styles.productBodyItemName}>Количество:</Text>
                                <Text style={styles.productBodyItemValue}>{product["Количество"]} ед</Text>
                            </View>
                        </View>
                    </View>
                )
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.inputBox} onTouchEnd={() => { loadScreen('Scan') }}>
                <Image
                    style={styles.scan}
            ...
            <View style={styles.inputBox}>
                <Text style={styles.inputLabel}>Запрос на принятие товара</Text>
            </View>
